...
public class SelectedTagFragmentShower extends DialogFragment {
    ...
    public SelectedTagFragmentShower() {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        if (selectedTag != null && !selectedTag.isEmpty()) {
            builder.setTitle(CURRENT_TAGS).setAdapter(new ShortTagsAdapter(getActivity(), selectedTag), null).setPositiveButton(OK, new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                }
            });
        } else {
            builder.setTitle(NO_TAGS_SELECTED).setPositiveButton(OK, null);
        }
