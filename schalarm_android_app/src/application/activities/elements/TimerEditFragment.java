...
import application.activities.main_tab_fragments.faces.TimeChangeListener;
...
public class TimerEditFragment extends DialogFragment {
    ...
    public TimerEditFragment(TimeChangeListener timeChangeListener) {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        alarmTime = timeChangeListener.getCurrentSettedTime();
        refreshTo(alarmTime);
    ...
    private DialogInterface.OnClickListener makePositive() {
        return new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                timeChangeListener.timeHasChanged(convertTime(), timePicker.getCurrentHour(), timePicker.getCurrentMinute());
            }
        };
    }
